...
- Большой релиз от базы 4.19.1, versionCode 71, compileSdk/targetSdk 37. Палитра и общая структура дизайна сохранены; изменения только над существующим дизайном.
